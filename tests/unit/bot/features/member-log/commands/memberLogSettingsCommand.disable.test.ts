// tests/unit/bot/features/member-log/commands/memberLogSettingsCommand.disable.test.ts

import { ValidationError } from "@ayasono/shared/core";
import { handleMemberLogSettingsDisable } from "@/bot/features/member-log/commands/memberLogSettingsCommand.disable";
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.guard",
  () => ({
...
// handleMemberLogSettingsDisable の権限チェック・無効化フローを検証
describe("bot/features/member-log/commands/memberLogSettingsCommand.disable", () => {
  ...
  it("ガードが ValidationError を投げた場合にそれが伝播することを確認", async () => {
    ...
    await expect(
      handleMemberLogSettingsDisable(makeInteraction() as never, "guild-1"),
  ...
  it("service.setEnabled(false) が正しい guildId を引数に呼ばれることを確認", async () => {
    ...
    await handleMemberLogSettingsDisable(interaction as never, "guild-1");
  ...
  it("成功時に logger.info が呼ばれることを確認", async () => {
    ...
    await handleMemberLogSettingsDisable(makeInteraction() as never, "guild-1");
