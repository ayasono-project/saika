// tests/unit/bot/features/guild-settings/commands/guildSettingsCommand.export.test.ts
...
import { handleExport } from "@/bot/features/guild-settings/commands/guildSettingsCommand.export";
...
describe("bot/features/guild-settings/commands/guildSettingsCommand.export", () => {
  ...
  it("設定が存在しない場合はエラーメッセージを返すこと", async () => {
    ...
    expect(createErrorEmbedMock).toHaveBeenCalledWith(
      "guildSettings:user-response.export_empty",
    );
    expect(interaction.reply).toHaveBeenCalledWith(
