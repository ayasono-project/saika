// src/bot/features/vc-recruit/commands/usecases/vcRecruitSettingsAddRole.ts
// vc-recruit-settings add-role のユースケース処理
...
/**
 * vc-recruit-settings add-role を実行する
 * RoleSelectMenu（複数選択可）をエフェメラルで表示する
 * @param interaction コマンド実行インタラクション
 */
export async function handleVcRecruitSettingsAddRole(
