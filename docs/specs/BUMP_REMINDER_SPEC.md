...
| `/bump-reminder-settings enable` | Bumpリマインダー機能を有効化 |
| `/bump-reminder-settings disable` | Bumpリマインダー機能を無効化 |
| `/bump-reminder-settings set-mention` | メンションロールを設定 |
| `/bump-reminder-settings remove-mention` | メンションロール設定を削除 |
| `/bump-reminder-settings remove-mention-users` | 通知登録ユーザーを選択して削除 |
| `/bump-reminder-settings view` | 現在の設定状態を表示 |
| `/bump-reminder-settings reset` | Bumpリマインダー設定をリセット |

### 権限モデル

| 対象 | 権限 | 用途 |
| --- | --- | --- |
| 実行者（`/bump-reminder-settings`） | ManageGuild | 設定コマンドの実行 |
...
- 無効化するには `/bump-reminder-settings disable` を実行してください
...
3. messageCreateイベントで検知
  ...
  - `interaction.commandName` が Disboard なら `bump`、ディス速なら `up` か確認
   ...
   - GuildSettings の enabled を確認（デフォルト true）
...
5. 2時間経過
   - タイマー発火
   - taskFactory 実行:
     a. GuildSettings から最新の設定を取得（enabled, mentionRoleId, mentionUserIds）
...
**コマンド**: `/bump-reminder-settings enable`
...
**コマンド**: `/bump-reminder-settings disable`
...
## /bump-reminder-settings set-mention

### コマンド定義

**コマンド**: `/bump-reminder-settings set-mention`
...
**コマンド**: `/bump-reminder-settings remove-mention`
...
**コマンド**: `/bump-reminder-settings remove-mention-users`
...
**コマンド**: `/bump-reminder-settings view`
...
**コマンド**: `/bump-reminder-settings reset`
...
- **GuildBumpReminderSettingsテーブル**: ギルド全体の設定（メンション対象など）
- リマインダー送信時に GuildBumpReminderSettings から最新の設定を取得することで、Bump検知後の設定変更も反映
...
| キー | 用途 | ja | en |
| --- | --- | --- | --- |
| `bump-reminder-settings.description` | コマンド説明 | Bumpリマインダーの設定（サーバー管理権限が必要） | Configure bump reminder (requires Manage Server) |
| `bump-reminder-settings.enable.description` | サブコマンド説明 | Bumpリマインダー機能を有効化 | Enable bump reminder feature |
| `bump-reminder-settings.disable.description` | サブコマンド説明 | Bumpリマインダー機能を無効化 | Disable bump reminder feature |
| `bump-reminder-settings.set-mention.description` | サブコマンド説明 | メンションロールを設定 | Set mention role |
| `bump-reminder-settings.set-mention.role.description` | オプション説明 | リマインダーでメンションするロール | Role to mention in reminders |
| `bump-reminder-settings.remove-mention.description` | サブコマンド説明 | メンションロール設定を削除 | Remove mention role setting |
| `bump-reminder-settings.remove-mention-users.description` | サブコマンド説明 | 通知ユーザーを削除 | Remove notification users |
| `bump-reminder-settings.reset.description` | サブコマンド説明 | Bumpリマインダー設定をリセット | Reset bump reminder settings |
| `bump-reminder-settings.view.description` | サブコマンド説明 | 現在の設定を表示 | Show current settings |
...
| 依存先 | 内容 |
| --- | --- |
| GuildSettingsRepository | Bumpリマインダー設定の取得・更新 |
