// src/bot/features/reaction-role/commands/usecases/reactionRoleSettingsAddButton.ts
...
/**
 * reaction-role-settings add-button サブコマンドを処理する
 * @param interaction コマンド実行インタラクション
 * @param guildId ギルドID
 */
export async function handleReactionRoleSettingsAddButton(
