// tests/unit/bot/features/ticket/commands/usecases/ticketSettingsSetAutoDelete.test.ts
...
describe("bot/features/ticket/commands/usecases/ticketSettingsSetAutoDelete", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("設定が見つからない場合はエラー応答", async () => {
    const { handleTicketSettingsSetAutoDelete } = await import(
    ...
    await handleTicketSettingsSetAutoDelete(interaction as never, "guild-1");
