...
vi.mock(
  "@/features/message-delete/commands/usecases/dialogUtils",
  async (importOriginal) => {
    const orig =
      await importOriginal<
        typeof import("@/features/message-delete/commands/usecases/dialogUtils")
      >();
    return {
      ...orig,
...
describe("bot/features/message-delete/commands/usecases/runFinalConfirmDialog", () => {
  ...
  async function loadModule() {
    return import(
      "@/features/message-delete/commands/usecases/runFinalConfirmDialog"
    );
  }
