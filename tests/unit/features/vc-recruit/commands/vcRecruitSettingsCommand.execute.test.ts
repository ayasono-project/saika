...
vi.mock(
  "@/features/vc-recruit/commands/usecases/vcRecruitSettingsSetup",
  () => ({
...
vi.mock(
  "@/features/vc-recruit/commands/usecases/vcRecruitSettingsTeardown",
  () => ({
...
vi.mock(
  "@/features/vc-recruit/commands/usecases/vcRecruitSettingsAddRole",
  () => ({
...
vi.mock(
  "@/features/vc-recruit/commands/usecases/vcRecruitSettingsRemoveRole",
  () => ({
...
vi.mock(
  "@/features/vc-recruit/commands/usecases/vcRecruitSettingsView",
  () => ({
