// tests/unit/bot/features/reaction-role/commands/usecases/reactionRoleSettingsRemoveButton.test.ts
...
describe("bot/features/reaction-role/commands/usecases/reactionRoleSettingsRemoveButton", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("パネルが0件の場合はエラー応答を返す", async () => {
    const { handleReactionRoleSettingsRemoveButton } = await import(
    ...
    await handleReactionRoleSettingsRemoveButton(
