...
import { handleVacDeleteUseCase } from "@/features/vac/services/usecases/handleVacDelete";
import {
  createVacService,
  getVacService,
  VacService,
} from "@/features/vac/services/vacService";
...
vi.mock("@/features/vac/services/usecases/handleVacDelete", () => ({
  handleVacDeleteUseCase: vi.fn(),
}));

vi.mock("@/features/vac/services/usecases/cleanupVacOnStartup", () => ({
