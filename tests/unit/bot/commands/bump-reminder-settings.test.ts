// tests/unit/bot/commands/bump-reminder-settings.test.ts
...
import { bumpReminderSettingsCommand } from "@/bot/commands/bump-reminder-settings";
...
// bump-reminder-settings 検証用 interaction モック
...
// bump-reminder-settings コマンドの各サブコマンド（enable/disable/set-mention/remove-mention/view）の分岐を検証
describe("bot/commands/bump-reminder-settings", () => {
  // ケースごとにモックを初期化する
  beforeEach(() => {
    vi.clearAllMocks();
