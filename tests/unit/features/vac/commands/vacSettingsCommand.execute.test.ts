...
vi.mock("@/features/vac/commands/usecases/vacSettingsCreateTrigger", () => ({
  handleVacSettingsCreateTrigger: vi.fn(),
}));

vi.mock("@/features/vac/commands/usecases/vacSettingsRemoveTrigger", () => ({
  handleVacSettingsRemoveTrigger: vi.fn(),
}));

vi.mock("@/features/vac/commands/usecases/vacSettingsView", () => ({
