// tests/unit/bot/features/member-log/commands/memberLogSettingsCommand.view.test.ts

import { ValidationError } from "@ayasono/shared/core";
import { handleMemberLogSettingsView } from "@/bot/features/member-log/commands/memberLogSettingsCommand.view";
...
// handleMemberLogSettingsView の設定表示ロジックを検証
describe("bot/features/member-log/commands/memberLogSettingsCommand.view", () => {
  ...
  it("ガードが ValidationError を投げた場合にそれが伝播することを確認", async () => {
    ...
    await expect(
      handleMemberLogSettingsView(makeInteraction() as never, "guild-1"),
  ...
  it("config が null の場合に not_configured メッセージで reply が呼ばれることを確認", async () => {
    ...
    await handleMemberLogSettingsView(interaction as never, "guild-1");
