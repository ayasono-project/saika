// tests/unit/bot/features/guild-settings/commands/guildSettingsCommand.execute.test.ts
...
vi.mock(
  "@/bot/features/guild-settings/commands/guildSettingsCommand.setLocale",
  () => ({
    handleSetLocale: (...args: unknown[]) => handleSetLocaleMock(...args),
  }),
);
vi.mock(
  "@/bot/features/guild-settings/commands/guildSettingsCommand.setErrorChannel",
  () => ({
...
vi.mock(
  "@/bot/features/guild-settings/commands/guildSettingsCommand.view",
  () => ({
    handleView: (...args: unknown[]) => handleViewMock(...args),
  }),
);
vi.mock(
  "@/bot/features/guild-settings/commands/guildSettingsCommand.reset",
  () => ({
    handleReset: (...args: unknown[]) => handleResetMock(...args),
  }),
);
vi.mock(
  "@/bot/features/guild-settings/commands/guildSettingsCommand.resetAll",
  () => ({
    handleResetAll: (...args: unknown[]) => handleResetAllMock(...args),
  }),
);
vi.mock(
  "@/bot/features/guild-settings/commands/guildSettingsCommand.export",
  () => ({
    handleExport: (...args: unknown[]) => handleExportMock(...args),
  }),
);
vi.mock(
  "@/bot/features/guild-settings/commands/guildSettingsCommand.import",
  () => ({
    handleImport: (...args: unknown[]) => handleImportMock(...args),
  }),
);

import { executeGuildSettingsCommand } from "@/bot/features/guild-settings/commands/guildSettingsCommand.execute";
...
describe("bot/features/guild-settings/commands/guildSettingsCommand.execute", () => {
  ...
  it("guildId が null の場合は ValidationError をスローすること", async () => {
    ...
    await expect(executeGuildSettingsCommand(interaction)).rejects.toThrow();
  });
