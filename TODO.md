...
>
> **2026-09-23 にパッケージ更新を完了した**（PR #112〜#118 の7本・→ HISTORY.md）。**develop マージ止まりで本番リリースはまだ。** 最大の成果は undici の CVE 4件解消（discord.js 14.27.0 経由）。typescript 7 と vitest 5 はいずれも**型エラーゼロ・設定変更なし**で通った。残るのは外部の期日待ちの Node 26 と prisma 8 だけで「完了待ち」へ移した。
>
