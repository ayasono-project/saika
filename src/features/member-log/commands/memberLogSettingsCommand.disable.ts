// src/bot/features/member-log/commands/memberLogSettingsCommand.disable.ts
// member-log-settings disable 実行処理
 ...
 */
export async function handleMemberLogSettingsDisable(
  ...
  // 機能を無効化
  await getBotMemberLogSettingsService().setEnabled(guildId, false);
