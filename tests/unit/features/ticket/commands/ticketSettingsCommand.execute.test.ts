...
vi.mock("@/features/ticket/commands/usecases/ticketSettingsSetup", () => ({
  handleTicketSettingsSetup: (...args: unknown[]) => setupMock(...args),
}));

vi.mock("@/features/ticket/commands/usecases/ticketSettingsTeardown", () => ({
...
vi.mock("@/features/ticket/commands/usecases/ticketSettingsEditPanel", () => ({
  handleTicketSettingsEditPanel: (...args: unknown[]) => editPanelMock(...args),
}));

vi.mock("@/features/ticket/commands/usecases/ticketSettingsSetRoles", () => ({
  handleTicketSettingsSetRoles: (...args: unknown[]) => setRolesMock(...args),
}));

vi.mock("@/features/ticket/commands/usecases/ticketSettingsAddRoles", () => ({
  handleTicketSettingsAddRoles: (...args: unknown[]) => addRolesMock(...args),
}));

vi.mock(
  "@/features/ticket/commands/usecases/ticketSettingsRemoveRoles",
  () => ({
...
vi.mock(
  "@/features/ticket/commands/usecases/ticketSettingsSetAutoDelete",
  () => ({
...
vi.mock(
  "@/features/ticket/commands/usecases/ticketSettingsSetMaxTickets",
  () => ({
