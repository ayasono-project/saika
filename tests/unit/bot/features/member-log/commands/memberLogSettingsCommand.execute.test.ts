...
import { executeMemberLogSettingsCommand } from "@/bot/features/member-log/commands/memberLogSettingsCommand.execute";
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.setChannel",
  () => ({
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.enable",
  () => ({
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.disable",
  () => ({
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.setJoinMessage",
  () => ({
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.setLeaveMessage",
  () => ({
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.view",
  () => ({
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.clearJoinMessage",
  () => ({
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.clearLeaveMessage",
  () => ({
...
vi.mock(
  "@/bot/features/member-log/commands/memberLogSettingsCommand.reset",
  () => ({
