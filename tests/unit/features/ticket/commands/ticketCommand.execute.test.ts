...
vi.mock("@/features/ticket/commands/usecases/ticketClose", () => ({
  handleTicketClose: (...args: unknown[]) => handleTicketCloseMock(...args),
}));

vi.mock("@/features/ticket/commands/usecases/ticketOpen", () => ({
  handleTicketOpen: (...args: unknown[]) => handleTicketOpenMock(...args),
}));

vi.mock("@/features/ticket/commands/usecases/ticketDelete", () => ({
