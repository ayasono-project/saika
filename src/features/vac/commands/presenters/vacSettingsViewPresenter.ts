...
export interface VacSettingsViewPresentation {
  title: string;
  fieldTrigger: string;
...
/**
 * vac-settings view の表示内容を整形する
 */
export async function presentVacSettingsView(
  guild: Guild,
  locale: string,
  config: VacSettings,
): Promise<VacSettingsViewPresentation> {
