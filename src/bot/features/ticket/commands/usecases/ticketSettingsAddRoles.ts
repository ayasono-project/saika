// src/bot/features/ticket/commands/usecases/ticketSettingsAddRoles.ts
// チケットスタッフロール追加処理
...
/**
 * ticket-settings add-roles サブコマンドを処理する
 * @param interaction コマンド実行インタラクション
 * @param guildId ギルドID
 */
export async function handleTicketSettingsAddRoles(
