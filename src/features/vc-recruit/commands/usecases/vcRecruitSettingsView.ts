// src/bot/features/vc-recruit/commands/usecases/vcRecruitSettingsView.ts
// vc-recruit-settings view のユースケース処理
...
/**
 * vc-recruit-settings view を実行する
 * @param interaction コマンド実行インタラクション
 * @param guildId 実行対象ギルドID
 */
export async function handleVcRecruitSettingsView(
  ...
  const config =
    await getBotVcRecruitRepository().getVcRecruitSettingsOrDefault(guildId);
