...
import type { ScannedMessageWithChannel } from "@/features/message-delete/constants/messageDeleteConstants";
import { MSG_DEL_CUSTOM_ID } from "@/features/message-delete/constants/messageDeleteConstants";
...
vi.mock(
  "@/features/message-delete/commands/usecases/runConditionSetupStep",
  () => ({
