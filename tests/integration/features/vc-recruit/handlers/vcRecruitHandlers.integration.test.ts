...
// パネルコンポーネントビルダーのモック
vi.mock("@/features/vc-recruit/commands/vcRecruitPanelEmbed", () => ({
...
describe("VC Recruit Handlers Integration", () => {
  ...
  describe("voiceStateUpdate: 空室VC自動削除", () => {
    async function loadHandler() {
      const mod = await import(
        "@/features/vc-recruit/handlers/vcRecruitVoiceStateUpdate"
      );
  ...
  describe("channelDelete: セットアップチャンネルのカスケード削除", () => {
    async function loadHandler() {
      const mod = await import(
        "@/features/vc-recruit/handlers/vcRecruitChannelDeleteHandler"
      );
  ...
  describe("messageDelete: パネルメッセージの自己修復", () => {
    async function loadHandler() {
      const mod = await import(
        "@/features/vc-recruit/handlers/vcRecruitMessageDeleteHandler"
      );
  ...
  describe("統合シナリオ: VC作成 → 空室 → 自動削除 → 募集メッセージ更新", () => {
    it("VCから全員退出すると自動削除され、channelDeleteハンドラが募集メッセージを更新すること", async () => {
      const voiceHandler = (
        await import("@/features/vc-recruit/handlers/vcRecruitVoiceStateUpdate")
