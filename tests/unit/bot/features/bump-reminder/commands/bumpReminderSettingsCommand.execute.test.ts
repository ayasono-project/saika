...
import { BUMP_REMINDER_SETTINGS_COMMAND } from "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.constants";
import { executeBumpReminderSettingsCommand } from "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.execute";
...
vi.mock(
  "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.guard",
  () => ({
...
vi.mock(
  "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.enable",
  () => ({
...
vi.mock(
  "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.disable",
  () => ({
...
vi.mock(
  "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.setMention",
  () => ({
...
vi.mock(
  "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.removeMention",
  () => ({
...
vi.mock(
  "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.removeUsers",
  () => ({
...
vi.mock(
  "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.reset",
  () => ({
...
vi.mock(
  "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.view",
  () => ({
