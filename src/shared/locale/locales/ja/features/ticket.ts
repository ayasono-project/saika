...
export const ticket = {
  ...
  "ticket-settings.description": "チケット機能の設定（サーバー管理権限が必要）",
  ...
  "ticket-settings.set-roles.description": "スタッフロールを上書き設定",
  "ticket-settings.set-roles.category.description": "対象カテゴリ",
  "ticket-settings.add-roles.description": "スタッフロールを追加",
  "ticket-settings.add-roles.category.description": "対象カテゴリ",
  "ticket-settings.remove-roles.description": "スタッフロールを削除",
  "ticket-settings.remove-roles.category.description": "対象カテゴリ",
  "ticket-settings.set-auto-delete.description": "自動削除期間を設定",
  "ticket-settings.set-auto-delete.category.description": "対象カテゴリ",
  "ticket-settings.set-auto-delete.days.description": "自動削除までの日数",
  "ticket-settings.set-max-tickets.description": "同時チケット上限を設定",
  "ticket-settings.set-max-tickets.category.description": "対象カテゴリ",
  "ticket-settings.set-max-tickets.count.description": "ユーザーあたりの上限数",
