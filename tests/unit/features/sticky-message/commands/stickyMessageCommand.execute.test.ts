...
vi.mock(
  "@/features/sticky-message/commands/usecases/stickyMessageRemove",
  () => ({ handleStickyMessageRemove: handleStickyMessageRemoveMock }),
);
vi.mock(
  "@/features/sticky-message/commands/usecases/stickyMessageView",
  () => ({ handleStickyMessageView: handleStickyMessageViewMock }),
);
vi.mock(
  "@/features/sticky-message/commands/usecases/stickyMessageUpdate",
