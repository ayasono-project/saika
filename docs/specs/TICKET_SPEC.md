...
1. 削除されたメッセージ ID / チャンネル ID から対応する `GuildTicketSettings` を特定
2. 該当設定を DB から削除
...
- 管理者が再設置したい場合は `/ticket-settings setup` で再度パネルを設置できる
...
**コマンド**: `/ticket-settings edit-panel`
...
## /ticket-settings set-roles

### コマンド定義

**コマンド**: `/ticket-settings set-roles`
...
## /ticket-settings add-roles

### コマンド定義

**コマンド**: `/ticket-settings add-roles`
...
## /ticket-settings remove-roles

### コマンド定義

**コマンド**: `/ticket-settings remove-roles`
...
## /ticket-settings set-auto-delete

### コマンド定義

**コマンド**: `/ticket-settings set-auto-delete`
...
## /ticket-settings set-max-tickets

### コマンド定義

**コマンド**: `/ticket-settings set-max-tickets`
...
| `staffRoleIds` | Json | スタッフロールID（jsonb 配列: `string[]`） |
...
| `ticket-settings.description` | コマンド説明 | チケット機能の設定（サーバー管理権限が必要） | Configure ticket feature (requires Manage Server) |
| `ticket-settings.setup.description` | サブコマンド説明 | チケットパネルを設置 | Set up ticket panel |
| `ticket-settings.setup.category.description` | オプション説明 | チケット作成先カテゴリ | Category for ticket channels |
| `ticket-settings.teardown.description` | サブコマンド説明 | チケットパネルを撤去 | Remove ticket panel |
| `ticket-settings.view.description` | サブコマンド説明 | 現在の設定を表示 | Show current settings |
| `ticket-settings.edit-panel.description` | サブコマンド説明 | パネルのタイトル・説明文を編集 | Edit panel title and description |
| `ticket-settings.edit-panel.category.description` | オプション説明 | 編集対象のカテゴリ | Target category |
| `ticket-settings.set-roles.description` | サブコマンド説明 | スタッフロールを上書き設定 | Set staff roles (overwrite) |
| `ticket-settings.set-roles.category.description` | オプション説明 | 対象カテゴリ | Target category |
| `ticket-settings.add-roles.description` | サブコマンド説明 | スタッフロールを追加 | Add staff roles |
| `ticket-settings.add-roles.category.description` | オプション説明 | 対象カテゴリ | Target category |
| `ticket-settings.remove-roles.description` | サブコマンド説明 | スタッフロールを削除 | Remove staff roles |
| `ticket-settings.remove-roles.category.description` | オプション説明 | 対象カテゴリ | Target category |
| `ticket-settings.set-auto-delete.description` | サブコマンド説明 | 自動削除期間を設定 | Set auto-delete period |
| `ticket-settings.set-auto-delete.category.description` | オプション説明 | 対象カテゴリ | Target category |
| `ticket-settings.set-auto-delete.days.description` | オプション説明 | 自動削除までの日数 | Days until auto-delete |
| `ticket-settings.set-max-tickets.description` | サブコマンド説明 | 同時チケット上限を設定 | Set max tickets per user |
| `ticket-settings.set-max-tickets.category.description` | オプション説明 | 対象カテゴリ | Target category |
| `ticket-settings.set-max-tickets.count.description` | オプション説明 | ユーザーあたりの上限数 | Max tickets per user |
...
| 依存先 | 内容 |
| --- | --- |
| GuildTicketSettings（DB） | チケット設定の取得・更新 |
