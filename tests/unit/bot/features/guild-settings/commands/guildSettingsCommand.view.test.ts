...
vi.mock(
  "@/bot/features/guild-settings/commands/guildSettingsCommand.viewPages",
  () => ({
...
import { handleView } from "@/bot/features/guild-settings/commands/guildSettingsCommand.view";
