// tests/unit/bot/features/vac/commands/presenters/vacSettingsViewPresenter.test.ts

import { ChannelType } from "discord.js";
import { presentVacSettingsView } from "@/bot/features/vac/commands/presenters/vacSettingsViewPresenter";
...
describe("bot/features/vac/commands/presenters/vacSettingsViewPresenter", () => {
  ...
  it("トリガーチャンネルと作成済みVCの詳細を整形して返す", async () => {
    ...
    const result = await presentVacSettingsView(guild as never, "ja", config);
