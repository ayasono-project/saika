...
### `/guild-settings reset-all` の確認ダイアログが削除範囲を過少申告していた（2026-09-20 修正）
...
### マニュアルの部分改訂（削除3機能の除去と嘘の記述の是正）（2026-09-20 develop merge）
...
> **`USER_MANUAL_URL` は `main` ブランチを指す**ため、この改訂はリリース（main マージ）後に初めて反映される。告知はその確認後に出す。
