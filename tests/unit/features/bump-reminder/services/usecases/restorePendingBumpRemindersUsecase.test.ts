...
vi.mock(
  "@/features/bump-reminder/services/helpers/bumpReminderRestorePlanner",
  () => ({
...
vi.mock(
  "@/features/bump-reminder/services/helpers/bumpReminderScheduleHelper",
  () => ({
...
vi.mock(
  "@/features/bump-reminder/services/helpers/bumpReminderTrackedTask",
  () => ({
