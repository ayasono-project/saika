// src/bot/features/reaction-role/commands/usecases/reactionRoleSettingsSetup.ts
...
/**
 * reaction-role-settings setup サブコマンドを処理する
 * @param interaction コマンド実行インタラクション
 * @param guildId ギルドID
 */
export async function handleReactionRoleSettingsSetup(
