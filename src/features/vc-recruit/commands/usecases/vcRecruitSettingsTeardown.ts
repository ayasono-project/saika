// src/bot/features/vc-recruit/commands/usecases/vcRecruitSettingsTeardown.ts
// vc-recruit-settings teardown のユースケース処理（ステップ1: セレクトメニュー表示）
...
/**
 * vc-recruit-settings teardown を実行する（ステップ1: セレクトメニュー表示）
 * @param interaction コマンド実行インタラクション
 * @param guildId 実行対象ギルドID
 */
export async function handleVcRecruitSettingsTeardown(
