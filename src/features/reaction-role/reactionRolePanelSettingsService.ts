 ...
 */
export class ReactionRolePanelSettingsService {
 ...
 */
export function createReactionRolePanelSettingsService(
  repository: IReactionRolePanelRepository,
): ReactionRolePanelSettingsService {
  return new ReactionRolePanelSettingsService(repository);
}
