...
import { handleBumpReminderSettingsEnable } from "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.enable";
...
describe("bot/features/bump-reminder/commands/bumpReminderSettingsCommand.enable", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("バンプリマインダーを現在のチャンネルで有効化し成功応答を返す", async () => {
    ...
    await handleBumpReminderSettingsEnable(interaction as never, "guild-1");
