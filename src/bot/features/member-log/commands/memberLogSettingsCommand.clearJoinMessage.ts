// src/bot/features/member-log/commands/memberLogSettingsCommand.clearJoinMessage.ts
// member-log-settings clear-join-message 実行処理
 ...
 */
export async function handleMemberLogSettingsClearJoinMessage(
  ...
  // 参加メッセージを削除
  await getBotMemberLogSettingsService().clearJoinMessage(guildId);
