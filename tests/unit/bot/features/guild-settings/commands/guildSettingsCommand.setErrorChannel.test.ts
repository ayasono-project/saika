...
import { handleSetErrorChannel } from "@/bot/features/guild-settings/commands/guildSettingsCommand.setErrorChannel";
...
describe("bot/features/guild-settings/commands/guildSettingsCommand.setErrorChannel", () => {
