...
import { handleBumpReminderSettingsReset } from "@/bot/features/bump-reminder/commands/bumpReminderSettingsCommand.reset";
...
vi.mock("@/shared/features/bump-reminder/bumpReminderSettingsDefaults", () => ({
