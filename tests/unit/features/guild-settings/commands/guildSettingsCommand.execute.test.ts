...
vi.mock(
  "@/features/guild-settings/commands/guildSettingsCommand.setErrorChannel",
  () => ({
    handleSetErrorChannel: (...args: unknown[]) =>
      handleSetErrorChannelMock(...args),
  }),
);
vi.mock("@/features/guild-settings/commands/guildSettingsCommand.view", () => ({
  handleView: (...args: unknown[]) => handleViewMock(...args),
}));
vi.mock(
  "@/features/guild-settings/commands/guildSettingsCommand.reset",
  () => ({
