...
vi.mock("@/features/reaction-role/services/reactionRolePanelBuilder", () => ({
...
describe("bot/features/reaction-role/commands/usecases/reactionRoleSettingsAddButton", () => {
  ...
  it("パネルが0件の場合はエラー応答を返す", async () => {
    const { handleReactionRoleSettingsAddButton } = await import(
    ...
    await handleReactionRoleSettingsAddButton(interaction as never, "guild-1");
